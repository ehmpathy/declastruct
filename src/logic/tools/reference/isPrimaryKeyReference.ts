...
export const isPrimaryKeyReference = <
  T,
  /**
...
>(
  ...
  identifiedBy: { key: DeclaredResourceReferenceKeyType.PRIMARY_KEY };
} => ref.identifiedBy.key === DeclaredResourceReferenceKeyType.PRIMARY_KEY;
