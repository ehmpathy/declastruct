...
switch (change.action) {
  case DeclastructChangeAction.CREATE:
    await dao.set.findsert(change.state.desired!, context);
    return change;
  // ...
}
```
